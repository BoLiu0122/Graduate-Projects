...
public class AccountantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 870, 141));
        ...
        add(refreshTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 60, -1, 40));

        enterpriseLabel.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        enterpriseLabel.setText("Enterprise :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 89, 30));

        valueLabel.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        valueLabel.setForeground(new java.awt.Color(204, 0, 0));
        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 100, 158, 30));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 310, -1, 30));
        ...
        add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 350, 220, 40));

        orderComboBox.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        add(orderComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 300, 220, 50));
        ...
        add(btnRequestTally, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 400, 370, 50));
